...
export function ContactSection() {
  const contacts = [
    { name: 'Email', url: `mailto:${socials.email}`, icon: 'email', label: socials.email },
    { name: 'GitHub', url: socials.github, icon: 'github', label: '@Kyne0328' },
    { name: 'LinkedIn', url: socials.linkedin, icon: 'linkedin', label: 'Connect' },
  ];
